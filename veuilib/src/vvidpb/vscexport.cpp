...
VSCExport::VSCExport(astring strStor, astring strId, astring strCamName, u32 startTime, QWidget *parent)
 : QDialog(parent), m_startTime(startTime), m_strId(strId), m_strStor(strStor), m_strCamName(strCamName)
{
	ui.setupUi(this);
	...
	connect(ui.startTime, SIGNAL(dateTimeChanged(QDateTime)), this, SLOT(StartDateTimeChanged(QDateTime)));
