 ...
 */
typedef hdfsFile (*hdfsOpenFileDelegate)(hdfsFS fs, const char* path, int flags, int bufferSize, short replication, tSize blocksize);
 ...
 */
typedef tSize (*hdfsWriteDelegate)(hdfsFS fs, hdfsFile file, const void* buffer, tSize length);
/** 
