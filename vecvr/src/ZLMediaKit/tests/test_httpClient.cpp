...
int main(int argc,char *argv[]) {
	...
	for(auto url : urlList){
		...
		//断点续传功能,开启后可能会遇到416的错误（因为上次文件已经下载完全）중단 점 재개 기능, 켜진 후 416 오류가 발생할 수 있습니다 (파일이 지난 번에 완전히 다운로드 되었기 때문에).
	...
	//设置http头，我们假设设置cookie //http 헤더를 설정하고 쿠키가 설정되었다고 가정합니다.
