...
namespace media {
    ...
    struct MEDIA_EXPORT H264SEIMessage {
        ...
        int payload_size;
        union {
            // Placeholder; in future more supported types will contribute to more union members here.
            H264SEIRecoveryPoint recovery_point;
        };
    };
    
    // Class to parse an Annex-B H.264 stream, as specified in chapters 7 and Annex B of the H.264 spec.
    ...
    public:
        ...
        // structures is managed here, not by the caller, as they are reused across NALUs.
        //
        ...
        // Parse a SEI message, returning it in |*sei_msg|, provided and managed by the caller.
