...
return kInvalidStream;                                         \
    ...
    H264Parser::Result H264Parser::ParseRefPicListModification(int num_ref_idx_active_minus1,
        ...
        // If we got here, we didn't get loop end marker prematurely, so make sure it is there for our client.
    ...
    H264Parser::Result H264Parser::ParseWeightingFactors(int num_ref_idx_active_minus1,
