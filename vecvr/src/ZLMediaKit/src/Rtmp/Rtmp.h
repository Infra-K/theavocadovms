...
#define CHUNK_SERVER_REQUEST			2 /*服务器像客户端发出请求时的chunkID*/ //서버가 클라이언트와 같은 요청을 보낼 때의 chunkID
#define CHUNK_CLIENT_REQUEST_BEFORE		3 /*客户端在createStream前,向服务器发出请求的chunkID*/ //클라이언트는 createStream 전에 요청 된 chunkID를 서버로 보냅니다.
#define CHUNK_CLIENT_REQUEST_AFTER		4 /*客户端在createStream后,向服务器发出请求的chunkID*/ //클라이언트는 createStream 후 요청 된 chunkID를 서버로 보냅니다.
#define CHUNK_AUDIO						6 /*音频chunkID*/ //오디오 청크 ID
#define CHUNK_VIDEO						7 /*视频chunkID*/ //비디오 chunkID
