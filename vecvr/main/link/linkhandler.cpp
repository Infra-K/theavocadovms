...
m_conn(NULL), m_bRealEvent(false), m_bSearchEvent(false), m_pEvent(pEvent), m_pCamSearch(NULL)
{
...
bool LinkHandler::ProcessLoginReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
...
bool LinkHandler::ProcessRegNotifyReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
	...
	m_server = server;
	m_conn = conn;
	m_pFactory.RegCameraChangeNotify(this, (FactoryCameraChangeNotify)(LinkHandler::CallChange));
...
bool LinkHandler::ProcessCamListReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessCamReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessAddCamReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
...
bool LinkHandler::ProcessDelCamReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool bRet = false;
...
bool LinkHandler::ProcessSetCamSchedReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
...
bool LinkHandler::ProcessGetStreamListReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
...
bool LinkHandler::ProcessDiskListReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessSysDiskListReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	...
	while(it.hasNext())
	{
		...
		if (diskType == HddInternalDrive || diskType == HddRemovableDrive || diskType == HddRemoteDrive)
		{
			VidDisk *pDisk = diskList->add_cviddisk();
...
bool LinkHandler::ProcessAddDiskReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessDelDiskReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessUpdateDiskLimitReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
/* License & Version */
bool LinkHandler::ProcessGetLicReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	...
	m_pFactory.GetLicense(strLic, strHostId, nCh, strType, strStartTime, strExpireTime);
...
bool LinkHandler::ProcessGetVerReq(Link::LinkCmd &req, CivetServer *server,  struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessConfLicReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessAddUserReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
...
/* Search */
bool LinkHandler::ProcessHasRecordReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
	...
	*pNewList = pSearchList;
	...
	for (s32 i = 0; i < pNewList->chasrec_size(); i ++)
	{
		...
		bool bRet = m_pFactory.SearchHasItems(pReq.strid(), item.nstart(), item.nend(), item.ntype());
		item.set_bhas(bRet);
	}
...
bool LinkHandler::ProcessSearchRecordReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	bool nRet = false;
	...
	m_pFactory.SearchItems(pReq.strid(), pReq.nstart(), pReq.nend(), pReq.ntype(), recMap);
...
bool LinkHandler::ProcessPtzCmdReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
	...
	m_pFactory.PtzAction(pReq.strid(), (FPtzAction)(pReq.naction()), (float)pReq.nparam());

	return true;
}

bool LinkHandler::ProcessCamSearchStartReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessCamSearchStopReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessRegEventReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessUnRegEventReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessHandleEventReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessEventSearchReq(Link::LinkCmd &req, CivetServer *server, struct mg_connection *conn)
{
	long long p = (long long)conn;
	Link::LinkCmd cmdResp;
...
bool LinkHandler::ProcessMsg(std::string &strMsg, CivetServer *server, struct mg_connection *conn)
{
	Link::LinkCmd cmd;
...
bool LinkHandler::SendRespMsg(Link::LinkCmd &resp, CivetServer *server, struct mg_connection *conn)
{
	std::string strMsg;

	::google::protobuf::util::Status status = ::google::protobuf::util::MessageToJsonString(resp, &strMsg);
	if (!status.ok())
	{
#ifdef AVOCADO_DEBUG
		R_LOG(logRINFO, "ERROR: %s %s %d\n", __FUNCTION__, __FILE__, __LINE__);
	...
	int ret = mg_websocket_write(conn, WEBSOCKET_OPCODE_TEXT, strMsg.c_str(), strMsg.length());
	if (ret == strMsg.length())
	{
		// VDC_DEBUG("%s %s %d %s\n", __FUNCTION__, __FILE__, __LINE__, strMsg.c_str());
		// {"type":"LINK_CMD_CAM_REC_ON_NOTIFY", "camIdNotify" : {"strId":"1e717cf6-7118-4443-a589-7ac623d749ea"}}
		return true;
	}
#ifdef AVOCADO_DEBUG
	R_LOG(logRINFO, "ERROR: %s %s %d\n", __FUNCTION__, __FILE__, __LINE__);
