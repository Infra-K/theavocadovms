...
REL=Avocadovms-$(version)-$(VE_OS)-$(VE_VER)-$(VE_ARCH)bit
...
ifeq ($(strip $(VE_OS)), macos)
	$(VE_CROSS_COMPILER)strip ./$(REL)/AvocadoMonitor.app/Contents/MacOS/Avocado*
	$(VE_CROSS_COMPILER)strip ./$(REL)/AvocadoStorage.app/Contents/MacOS/Avocado*
	cp -r ./output/$(VE_INSTALL_DIR)/plugins/* ./$(REL)/AvocadoMonitor.app/Contents/MacOS/
	cp -r ./output/$(VE_INSTALL_DIR)/plugins/* ./$(REL)/AvocadoStorage.app/Contents/MacOS/
	...
	$(VE_CROSS_COMPILER)strip ./$(REL)/Avocado*
