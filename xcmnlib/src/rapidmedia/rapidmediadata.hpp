...
public:
	static void RapidRTSPEventHandle(int eventType, int lParam, void *rParam, void *context);
...
public:
	BOOL Init(BOOL bRealStream, string strUrl, string strUser, string strPass, BOOL bHWAccel, VSCConnectType connectType);
