...
BOOL RapidMedia::Init(BOOL bRealStream, string strUrl, string strUser, string strPass, BOOL bHWAccel, VSCConnectType connectType)
{
...
{
	if (packet.frameType != VIDEO_FRM_I || packet.dataBuf == NULL || packet.dataLen == 0)
	{
		return false;
	}
