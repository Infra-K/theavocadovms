...
{
public:
	CRapidRTSP(std::string streamUrl, int transport, std::string userName, std::string userPwd, bool bEnableAudio);
	virtual ~CRapidRTSP();
...
{
public:
	CRapidRTSPFFMPEG(std::string streamUrl, int transport, std::string userName, std::string userPwd, bool bEnableAudio);
	~CRapidRTSPFFMPEG();
...
{
public:
	CRapidRTSPLive555(std::string streamUrl, int transport, std::string userName, std::string userPwd, bool bEnableAudio);
	~CRapidRTSPLive555();
