...
///
/// The \c fast_mutex class is NOT compatible with the \c condition_variable class (however, it IS compatible with the \c lock_guard class).
/// It should also be noted that the \c fast_mutex class typically does not provide as accurate thread scheduling as a the standard \c mutex class does.
///
...
/// which is currently only supported for 32/64-bit Intel x86/AMD64 and PowerPC architectures on a limited number of compilers (GNU g++ and MS Visual C++).
