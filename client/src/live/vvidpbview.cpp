...
VVidPBView::VVidPBView(ClientFactory &pFactory, QWidget *parent, QTabWidget &pTabbed, QString strName)
 : m_pFactory(pFactory), QWidget(parent), m_pTabbed(pTabbed), m_currentFocus(-1), m_bControlEnable(TRUE), m_strName(strName), m_bFloated(FALSE), m_TimerTour(NULL)
{
    ui.setupUi(this);
    m_pParent = parent;
...
void VVidPBView::CameraDoubleClicked(astring strStor, astring strCam, astring strCamName)
{
