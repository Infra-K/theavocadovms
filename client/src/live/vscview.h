...
public:
    VSCView(ClientFactory &pFactory, QWidget *parent, QTabWidget &pTabbed, QString strName, bool bMainView = false);
    ~VSCView();
...
public slots:
	...
	void SetLayoutMode1()
	{
		m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/1x1.png")));
		SlotUpdateMainView();
	}
	void SetLayoutMode2x2()
	{
		m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/2x2.png")));
		SlotUpdateMainView();
	}
#if 0
//infrak 
	...
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/4x4.png")));
		SlotUpdateMainView();
	}
	void SetLayoutMode3x3()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/3x3.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode6()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/6.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode12p1()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/12+1.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode5x5()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/5x5.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode6x6()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/6x6.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode8x8()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/8x8.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode1x3()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/1x3.png")));
	 	SlotUpdateMainView();
	}
	void SetLayoutMode1p6()
	{
	    m_pTabbed.setTabIcon(m_pTabbed.indexOf(this), QIcon(tr(":/view/resources/1p6.png")));
	 	SlotUpdateMainView();
	}
#endif
